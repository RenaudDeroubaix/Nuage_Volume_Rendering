...
LINK          = g++
LFLAGS        = -Wl,--no-undefined -Wl,-O1
LIBS          = $(SUBLIBS) -Lexternal/libQGLViewer-2.6.1/QGLViewer -lQGLViewer -lglut -lGLU -lgsl -lblas -lgomp /usr/lib/x86_64-linux-gnu/libQt5OpenGL.so /usr/lib/x86_64-linux-gnu/libQt5Widgets.so /usr/lib/x86_64-linux-gnu/libQt5Gui.so /usr/lib/x86_64-linux-gnu/libQt5Xml.so /usr/lib/x86_64-linux-gnu/libQt5Core.so -lGL -lpthread   
AR            = ar cqs
RANLIB        = 
SED           = sed
STRIP         = strip
...
distdir: FORCE
	...
	$(COPY_FILE) --parents header/Window.h header/TextureViewer.h header/Texture.h header/TextureDockWidget.h header/Vec3D.h $(DISTDIR)/
...
compiler_moc_header_make_all: moc/moc_Window.cpp moc/moc_TextureViewer.cpp moc/moc_TextureDockWidget.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) moc/moc_Window.cpp moc/moc_TextureViewer.cpp moc/moc_TextureDockWidget.cpp
